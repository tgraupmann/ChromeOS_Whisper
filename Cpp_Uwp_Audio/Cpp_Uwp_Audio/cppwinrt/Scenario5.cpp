...
#pragma region UI Event Handlers
    ...
    void Scenario5::btnStopCapture_Click(IInspectable const&, RoutedEventArgs const&)
    {
        StopCapture();
    }
#pragma endregion
    ...
    fire_and_forget Scenario5::OnDeviceStateChange(IDeviceStateSource const&, SDKTemplate::DeviceStateChangedEventArgs e)
    {
    ...
    fire_and_forget Scenario5::OnPlotDataReady(IPlotDataSource const&, SDKTemplate::PlotDataReadyEventArgs e)
    {
        auto lifetime = get_strong();
    ...
    //  InitializeCapture()
    //
    void Scenario5::InitializeCapture()
    {
        m_capture = nullptr;
