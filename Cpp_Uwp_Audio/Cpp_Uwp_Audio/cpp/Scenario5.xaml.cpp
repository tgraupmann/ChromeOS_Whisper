...
void Scenario5::ShowStatusMessage( Platform::String^ str, NotifyType messageType )
{
...
void Scenario5::UpdateMediaControlUI( DeviceState deviceState )
{
    switch( deviceState )
    {
...
void Scenario5::btnStartCapture_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ShowStatusMessage( "", NotifyType::StatusMessage );
    InitializeCapture( sender, e );
}

void Scenario5::btnStopCapture_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void Scenario5::OnDeviceStateChange( Object^ sender, DeviceStateChangedEventArgs^ e )
{
    String^ strMessage = "";
...
void Scenario5::OnPlotDataReady( Object^ sender, PlotDataReadyEventArgs^ e )
{
...
//  InitializeCapture()
//
void Scenario5::InitializeCapture( Platform::Object^ sender, Object^ e )
{
    HRESULT hr = S_OK;
    ...
    // Register for events
    m_deviceStateChangeToken = m_StateChangedEvent->StateChangedEvent += ref new DeviceStateChangedHandler( this, &Scenario5::OnDeviceStateChange );
    m_plotDataReadyToken = PlotDataReadyEvent::PlotDataReady += ref new PlotDataReadyHandler( this, &Scenario5::OnPlotDataReady );
...
//  StopCapture()
//
void Scenario5::StopCapture( Platform::Object^ sender, Object^ e )
{
    if (m_spCapture)
    {
